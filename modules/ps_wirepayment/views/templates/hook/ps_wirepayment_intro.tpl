...
<section>
  ...
  <p>
    {if $bankwireCustomText }
        <a class="btn btn-sm bg-white" data-toggle="modal" data-target="#bankwire-modal">{l s='More information' d='Modules.Wirepayment.Shop'}</a>
    {/if}
  </p>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title">{l s='Bankwire' d='Modules.Wirepayment.Shop'}</h2>
